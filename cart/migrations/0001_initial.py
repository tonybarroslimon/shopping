...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cart_cartitem', (
            ...
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 7, 0, 0), auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        ...
        'cart.cartitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['products.Products']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
